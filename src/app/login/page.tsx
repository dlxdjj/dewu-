...
export default function LoginPage() {
  ...
  return <section className="mx-auto mt-20 max-w-sm rounded-[28px] border border-separator bg-card p-6 shadow-[var(--cirrus-shadow-2)]">
    ...
    <button type="button" disabled={busy} onClick={() => void submit()} className="mt-4 w-full rounded-full bg-tint py-3.5 font-medium text-white shadow-[var(--cirrus-shadow-2)] disabled:opacity-40">{busy ? "登录中…" : "登录"}</button>
