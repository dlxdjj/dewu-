...
export default function LoginPage() {
  ...
  return <section className="mx-auto mt-20 max-w-sm rounded-2xl bg-card p-5 shadow-sm">
    ...
    <input aria-label="邮箱" type="email" autoComplete="email" value={email} onChange={(e) => setEmail(e.target.value)} className="mt-5 w-full rounded-xl bg-background px-3 py-3 outline-none" placeholder="name@example.com" />
    <input aria-label="密码" type="password" autoComplete="current-password" value={password} onChange={(e) => setPassword(e.target.value)} className="mt-3 w-full rounded-xl bg-background px-3 py-3 outline-none" placeholder="密码" />
